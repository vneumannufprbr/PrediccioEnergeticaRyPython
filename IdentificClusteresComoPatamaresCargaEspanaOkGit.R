...
# Esta parte ya funcionaba correctamente.
...
# ---
# Paso 3: Crear un dendrograma con clustering jerárquico (MÉTODO CORREGIDO)
# ---
...
# Asumiendo que ya tienes el dataframe 'demand_data'
...
# Graficamos la serie temporal, coloreando por nivel de demanda
# Usamos una muestra para que el gráfico sea más rápido y legible
ggplot(sample_n(demand_data_con_tiempo, 5000), aes(x = time_index, y = total_load, color = level)) +
  geom_line(alpha = 0.8) + # Usamos geom_line para conectar los puntos
